...
static t_color calc_avg_color(t_map *map) {
  ...
  if (!map->floor_image)
    return (
        rgba(map->floor_color.r, map->floor_color.g, map->floor_color.b, 0x99));
...
void minimap_create(t_minimap *minimap, t_r3d *r3d, t_map *map,
                    t_alloc_table *at) {
  rasterizer_init_overlay(&minimap->rast, r3d,
                          (t_rect){{0, 0}, {WIDTH, HEIGHT}}, 70.0, at);
  minimap->map = map;
  minimap->bg = calc_avg_color(map);
}

static void draw_cube(t_minimap *minimap, t_vars *vars, t_v3 pos) {
  // const t_mat4	m = mat4_mul_mat4(mat4_rotation(v3(M_PI / 3, 0,
  // minimap->rast.r3d->camera->rotation.y)), mat4_translation(pos));
  const t_mat4 m = mat4_mul_mat4(
      mat4_rotation(v3(0, 0, minimap->rast.r3d->camera->rotation.y)),
      mat4_translation(pos));

  //
  // Top face
  //
  t_tri tri = (t_tri){.v0 = v3(-0.5, -0.5, +0.5),
                      .v1 = v3(+0.5, -0.5, +0.5),
                      .v2 = v3(-0.5, +0.5, +0.5)};
  t_tri tri2 = (t_tri){.v0 = v3(+0.5, -0.5, +0.5),
                       .v1 = v3(+0.5, +0.5, +0.5),
                       .v2 = v3(-0.5, +0.5, +0.5)};
  ...
  // -Y face
  //
  t_tri tri3 = (t_tri){.v0 = v3(-0.5, -0.5, -0.5),
                       .v1 = v3(+0.5, -0.5, -0.5),
                       .v2 = v3(-0.5, -0.5, +0.5),
                       ...
                       .t1 = (t_v2){1, 1},
                       .t2 = (t_v2){0, 1}};
  t_tri tri4 = (t_tri){.v0 = v3(+0.5, -0.5, -0.5),
                       .v1 = v3(+0.5, -0.5, +0.5),
                       .v2 = v3(-0.5, -0.5, +0.5),
  ...
  // +Y face
  //
  t_tri tri5 = (t_tri){.v0 = v3(-0.5, +0.5, -0.5),
                       .v2 = v3(+0.5, +0.5, -0.5),
                       .v1 = v3(-0.5, +0.5, +0.5),
                       ...
                       .t2 = (t_v2){1, 1},
                       .t1 = (t_v2){0, 1}};
  t_tri tri6 = (t_tri){.v0 = v3(+0.5, +0.5, -0.5),
                       .v2 = v3(+0.5, +0.5, +0.5),
                       .v1 = v3(-0.5, +0.5, +0.5),
  ...
  // +X face
  //
  t_tri tri7 = (t_tri){.v0 = v3(+0.5, -0.5, -0.5),
                       .v1 = v3(+0.5, +0.5, -0.5),
                       .v2 = v3(+0.5, -0.5, +0.5),
                       ...
                       .t1 = (t_v2){1, 1},
                       .t2 = (t_v2){0, 1}};
  t_tri tri8 = (t_tri){.v0 = v3(+0.5, +0.5, -0.5),
                       .v1 = v3(+0.5, +0.5, +0.5),
                       .v2 = v3(+0.5, -0.5, +0.5),
  ...
  // +X face
  //
  t_tri tri9 = (t_tri){.v0 = v3(-0.5, -0.5, -0.5),
                       .v2 = v3(-0.5, +0.5, -0.5),
                       .v1 = v3(-0.5, -0.5, +0.5),
                       ...
                       .t2 = (t_v2){1, 1},
                       .t1 = (t_v2){0, 1}};
  t_tri tri10 = (t_tri){.v0 = v3(-0.5, +0.5, -0.5),
                        .v2 = v3(-0.5, +0.5, +0.5),
                        .v1 = v3(-0.5, -0.5, +0.5),
  ...
  tri9.v0 = mat4_multiply_v3(m, tri9.v0),
  tri9.v1 = mat4_multiply_v3(m, tri9.v1),
  tri9.v2 = mat4_multiply_v3(m, tri9.v2);
  tri10.v0 = mat4_multiply_v3(m, tri10.v0),
  tri10.v1 = mat4_multiply_v3(m, tri10.v1),
  tri10.v2 = mat4_multiply_v3(m, tri10.v2);
  ...
  while (x < minimap->map->width) {
    ...
    while (y < minimap->map->height) {
      if (minimap->map->tiles[x + y * minimap->map->width] != TILE_EMPTY &&
        ...
        draw_cube(minimap, vars,
                  v3_sub(v3(x, y, -8), v3(r3d->camera->position.x,
                                          r3d->camera->position.z, 0)));
      else if (minimap->map->tiles[x + y * minimap->map->width] == TILE_DOOR) {
        draw_floor(minimap, vars,
                   v3_sub(v3(x, y, -8), v3(r3d->camera->position.x,
                                           r3d->camera->position.z, 0)));
        draw_door(minimap, vars,
                  v3_sub(v3(x, y, -8), v3(r3d->camera->position.x,
                                          r3d->camera->position.z, 0)));
      } else
        draw_floor(minimap, vars,
