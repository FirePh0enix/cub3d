...
/*   Updated: 2024/03/16 17:33:31 by ledelbec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *   triangles. (Fixed by adding 1.0 to scanline_y for bottom flat triangles)
 */
...
void	r3d_fill_triangle(t_r3d *r3d, t_tri tri, t_mtl *mtl)
{
	...
	else
	{
		...
		t3 = (t_v2){
			stri.t0.x + (float)(stri.v1.x - stri.v0.x) / (float)(stri.v2.x - stri.v0.x) * (stri.t2.x - stri.t0.x),
